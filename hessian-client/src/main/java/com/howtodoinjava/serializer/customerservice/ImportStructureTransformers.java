...
/**
 * Transformer provider for ImportStructure java data object.
 *
 */
public class ImportStructureTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public ImportStructureTransformers() {
        super(new ImportStructureJavaToHostTransformer(),
                new ImportStructureHostToJavaTransformer());
    }
     ...
     */
    public ImportStructure toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public ImportStructure toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public ImportStructure toJava(final byte[] hostData, final int offset,
