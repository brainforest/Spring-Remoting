...
/**
 * Transformer provider for ExportStructure java data object.
 *
 */
public class ExportStructureTransformers extends AbstractTransformers {

    /**
     * Create a set of directional transformers.
     */
    public ExportStructureTransformers() {
        super(new ExportStructureJavaToHostTransformer(),
                new ExportStructureHostToJavaTransformer());
    }
     ...
     */
    public ExportStructure toJava(final byte[] hostData, final String hostCharset)
     ...
     * @throws HostTransformException if transformation fails
     */
    public ExportStructure toJava(final byte[] hostData)
            throws HostTransformException {
     ...
     * @throws HostTransformException if transformation fails
     */
    public ExportStructure toJava(final byte[] hostData, final int offset,
